...
dfSummary(clinData$time_to_recurrence)
...
```{r}
clinData <- clinData %>%
  mutate(Days.to.first.recurrence = case_when(!is.na(Days.to.local.recurrence.from.the.date.of.diagnosis.clean) & !is.na(Days.to.distant.recurrence.from.the.date.of.diagnosis.clean) ~ pmin(Days.to.local.recurrence.from.the.date.of.diagnosis.clean, Days.to.distant.recurrence.from.the.date.of.diagnosis.clean)))

clinData$Days.to.first.recurrence
```
